      ...
      <div className="container-max grid gap-12 lg:grid-cols-2">
        <Reveal>
          ...
          <ul className="mt-8 space-y-4 text-sm text-white/80">
            <li className="flex items-center gap-3">
              <span className="grid h-10 w-10 place-items-center rounded-xl bg-navy shadow-sm">📞</span>
              +94 74 102 2110
            </li>
            <li className="flex items-center gap-3">
              <span className="grid h-10 w-10 place-items-center rounded-xl bg-navy shadow-sm">✉️</span>
              info@tthi.lk
            </li>
            <li className="flex items-center gap-3">
              <span className="grid h-10 w-10 place-items-center rounded-xl bg-navy shadow-sm">📍</span>
        ...
        <Reveal delay={0.15}>
          <form
            ...
            className="rounded-2xl bg-navy-50 p-7 shadow-sm"
          >
            <div className="grid gap-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full rounded-xl border border-navy-50 bg-black px-4 py-3 text-sm text-white outline-none transition-colors placeholder:text-white/30 focus:border-gold"
                />
              </div>
              <button
                type="submit"
                className="rounded-full bg-gold px-6 py-3 text-sm font-semibold text-black transition-transform hover:scale-[1.02]"
              >
